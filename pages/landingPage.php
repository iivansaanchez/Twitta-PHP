    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="d-flex justify-content-center mt-4">
                ...
                <button id="searchButton" class="btn btn-light w-50 mx-0">
            ...
            <div id="tweetsSection" class="mt-4">
                <?php if (!empty($_SESSION["listTweetGeneral"])): ?>
                    <?php foreach ($_SESSION["listTweetGeneral"] as $tweet): ?>
                        <div class="card mb-3"> <!-- Tarjeta ocupando todo el ancho -->
                            <div class="card-body">
                                <h5 class="card-title d-flex justify-content-between align-items-center">
                                    <a href="../profile.php?user=<?php echo htmlspecialchars($tweet['userId']); ?>" class="text-decoration-none text-dark">
                ...
                <?php else: ?>
                    <div class="alert alert-light" role="alert">
                        No tweets yet. Share your thoughts!
                    </div>
                <?php endif; ?>
            </div>
        </div>
